    ...
    <div className="min-h-screen bg-slate-50 py-10 px-4">
      <div className="max-w-2xl mx-auto">
        ...
        <div className="flex items-center justify-center mb-6">
          <img src="/logo.png" alt="Anchor Africa" className="h-12 object-contain" />
        </div>
        ...
        <form onSubmit={handleSubmit} noValidate>
          ...
          <div className="border border-t-0 border-gray-100 shadow-sm rounded-b-2xl overflow-hidden bg-gray-100/60">
            ...
            {form.fields.map((field, idx) => {
              ...
              const span = isHeading || (field.colSpan ?? 2) >= 2
        ...
        {/* Footer */}
        <footer className="mt-10 rounded-2xl overflow-hidden" style={{ background: '#1a3345' }}>
          {/* Contact bar */}
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-5">
              ...
              <div className="flex items-start gap-3">
                ...
                <div>
                  ...
                  <a href="tel:+231775608020" className="text-sm text-white/80 hover:text-primary block transition-colors">+231-775-608020</a>
                  <a href="tel:+231881608020" className="text-sm text-white/80 hover:text-primary block transition-colors">+231-881-608020</a>
                </div>
              </div>
              {/* Email */}
              <div className="flex items-start gap-3">
                ...
                <div>
                  ...
                  <a href="mailto:info@anchorafrica.org" className="text-sm text-white/80 hover:text-primary transition-colors">info@anchorafrica.org</a>
                </div>
              </div>
              {/* Address */}
              <div className="flex items-start gap-3">
                ...
                <div>
                  ...
                  <p className="text-sm text-white/80 leading-snug">Swankamore, SKD Blvd.,<br />Paynesville, Liberia</p>
                </div>
              </div>
              {/* Hours */}
              <div className="flex items-start gap-3">
                ...
                <div>
                  ...
                  <p className="text-sm text-white/80 leading-snug">Mon–Thu: 8:00am–5:00pm<br />Fri: 8:00am–1:00pm</p>
                </div>
              </div>
            </div>
          </div>
          ...
          {/* Copyright bar */}
          <div className="px-6 py-4 flex flex-col sm:flex-row items-center justify-between gap-3" style={{ background: '#273338' }}>
            <p className="text-xs text-white/50 text-center sm:text-left">
              &copy; {new Date().getFullYear()}{' '}
              <a href="https://anchorafrica.org" target="_blank" rel="noopener noreferrer" className="text-white font-medium hover:text-primary transition-colors">
                ANCHOR Africa
              </a>
              {' '}— All Rights Reserved.
            </p>
            <div className="flex items-center gap-4">
              <a href="https://anchorafrica.org" target="_blank" rel="noopener noreferrer" className="text-xs text-white/50 hover:text-primary transition-colors">Privacy Policy</a>
              <a href="https://anchorafrica.org" target="_blank" rel="noopener noreferrer" className="text-xs text-white/50 hover:text-primary transition-colors">Terms &amp; Conditions</a>
            </div>
          </div>
        </footer>
      </div>
